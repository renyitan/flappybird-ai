...
BACKGROUND_IMG = pygame.transform.scale2x(pygame.image.load(os.path.join('assets', 'bg.png')))
...
class Bird:
    ...
    ANIMATION_TIME = 5 # how long are we going to show the bird's animation (i.e. flapping)
    ...
    def move(self):
        ...
        d = self.vel*self.tick_count + 1.5*self.tick_count**2 #displacement: how many pixels to move up/down
...
class Pipe: 
    ...
    def __init__(self, x):
        ...
        self.PIPE_TOP = pygame.transform.flip(PIPE_IMG, False, True) # uprooted PIPE IMAGE
